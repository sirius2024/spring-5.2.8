...
public abstract class AbstractDispatcherServletInitializer extends AbstractContextLoaderInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		//创建根上下文(spring容器父容器)，创建ContextLoaderListener
	...
	protected void registerDispatcherServlet(ServletContext servletContext) {
		...
		//创建mvc的上下文 springmvc的上下文在这里面并没有启动 而是在DispatcherServlet-HttpServletBean init方法里面
		...
		//把DispatcherServlet丢到servlet上下文中  加入Servlet容器
	...
	protected FrameworkServlet createDispatcherServlet(WebApplicationContext servletAppContext) {
		//Servlet规范知道tomcat容器启动加载了Servlet必调Servlet的init方法
