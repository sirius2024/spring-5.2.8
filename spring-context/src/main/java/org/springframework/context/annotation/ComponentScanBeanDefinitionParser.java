...
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		//注册比较重要的后置类
		//ConfigurationClassPostProcessor(会扫描@Configuration@Component@Bean注解的解析)、AutowiredAnnotationBeanPostProcessor(会扫描@Value和@Autowired注解)、CommonAnnotationBeanPostProcessor
	...
	protected void registerComponents(
		...
		// Register annotation config processors, if necessary. 注册注释配置处理器
